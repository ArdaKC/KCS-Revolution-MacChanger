...
if language == "1":
    ...
    if os.path.isfile(PATH) and os.access(PATH, os.R_OK):
        ...
        ayarlar = "00"
    ayarlar1 = ayarlar
    print("KCS RevolutionMacChanger 2021.1.2-^")
     ...
     if ayarlar1.find("1") == -1:
      ...
      while a > 10:
          ...
          if os.system("ifconfig " + arayüz + " down") == 0:
             ...
             sa = os.system('systemctl status >xterm 2>&1')
             as1 = os.system('rc-status >xterm 2>&1')
             as2 = os.system("service --status-all >xterm 2>&1")

             if sa == 0:

                 if os.system("systemctl stop NetworkManager") == 0:
                     print("NetworkManager Servisi Başarıyla Durduruldu.")
                 else:
                     print("NetworkManager Servisi erişilebilir değil.")
             else:
                 if as1 == 0:
                     if os.system("rc-service network-manager stop") == 0:
                         print("NetworkManager Servisi Başarıyla Durduruldu.")
                     else:
                         print("NetworkManager Servisi erişilebilir değil.")
                 else:
                     ...
                     if as2 == 0:
                         if os.system("service stop network-manager") == 0:
                             print("NetworkManager Servisi Başarıyla Durduruldu.")
                         else:
                             print("NetworkManager Servisi erişilebilir değil.")
                     else:
                         if os.system("service stop network-manager") == 0:
                             ...
                             print("linux sistem bileşeniniz bilinmiyor veya NetworkManager Servisine Erişilemiyor.")
             ...
             if os.system("ifconfig " + arayüz + " hw " + "ether " + mac) == 0:
                 ...
                 if sa == 0:
                     ...
                     if os.system("systemctl start NetworkManager") == 0:
                         print("NetworkManager Servisi Başarıyla Başlatıldı.")
                     else:
                         print("NetworkManager Servisi erişilebilir değil.")
                 else:
                     if as1 == 0:
                         if os.system("rc-service network-manager start") == 0:
                             print("NetworkManager Servisi Başarıyla Başlatıldı.")
                         else:
                             print("NetworkManager Servisi erişilebilir değil.")
                     else:
                         ...
                         if as2 == 0:
                             if os.system("service start network-manager") == 0:
                                 print("NetworkManager Servisi Başarıyla Başlatıldı.")
                             else:
                                 print("NetworkManager Servisi erişilebilir değil.")
                         else:
            ...
            while a > 10:
                ...
                if os.system("ifconfig " + arayüz + " down") == 0:
                    ...
                    if sa == 0:
                        ...
                        if os.system("systemctl stop NetworkManager") == 0:
                            print("NetworkManager service successfully stopped")
                        else:
                            print("NetworkManager service not accessible")
                    else:
                        if as1 == 0:
                            if os.system("rc-service network-manager stop") == 0:
                                print("NetworkManager service successfully stopped")
                            ...
                            if as2 == 0:
                                ...
                                if os.system("service stop network-manager") == 0:
                                    ...
                                    print(
                                        "your linux system init is unknown or NetworkManager service not accessible")
                    ...
                    if os.system("ifconfig " + arayüz + " hw " + "ether " + mac) == 0:
                        ...
                        if sa == 0:
                            ...
                            if os.system("systemctl start NetworkManager") == 0:
                                print("NetworkManager service successfully started")
                            else:
                                print("NetworkManager service not accessible")
                        else:
                            if as1 == 0:
